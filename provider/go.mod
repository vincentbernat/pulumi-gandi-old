...
replace (
	github.com/go-gandi/terraform-provider-gandi v1.1.2-0.20211213160242-5efce47f8b7f => github.com/vincentbernat/terraform-provider-gandi v1.1.2-0.20211222193532-a74af1581747
