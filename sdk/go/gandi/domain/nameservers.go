...
func NewNameservers(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gandi:domain/nameservers:Nameservers", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNameservers(ctx *pulumi.Context,
	...
	var resource Nameservers
	err := ctx.ReadResource("gandi:domain/nameservers:Nameservers", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
