...
func NewGlueRecord(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gandi:domain/glueRecord:GlueRecord", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlueRecord(ctx *pulumi.Context,
	...
	var resource GlueRecord
	err := ctx.ReadResource("gandi:domain/glueRecord:GlueRecord", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
